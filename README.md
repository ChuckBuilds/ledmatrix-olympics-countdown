...
```bash
./dev_plugin_setup.sh link-github olympics-countdown
```
...
1. Clone the repository:
   ```bash
   git clone https://github.com/ChuckBuilds/ledmatrix-olympics-countdown.git
   ```

2. Link to LEDMatrix plugins directory:
   ```bash
   ./dev_plugin_setup.sh link olympics-countdown /path/to/ledmatrix-olympics-countdown
   ```
